  ...
  return (
    <header className="sticky top-0 z-40 border-b border-emerald-900/30 bg-[#06110e]/90 px-4 py-4 backdrop-blur-xl sm:px-6 lg:px-8">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="hidden max-w-md flex-1 items-center gap-3 rounded-2xl border border-emerald-900/30 bg-white/3 px-4 py-3 md:flex">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="grid h-11 w-11 place-items-center rounded-2xl border border-emerald-900/30 bg-white/3 text-slate-300"
          >
